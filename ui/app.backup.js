...
function ensureMesRequirementHeaderAlignment() {
    ...
    if (!header) {
        ...
        header.innerHTML = '<div>WO</div><div>File name</div><div></div>';
        list.parentNode.insertBefore(header, list);
    }
    header.className = 'hidden md:grid md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.2fr)_40px] gap-2 mb-2 px-0 text-[11px] font-bold uppercase tracking-wide text-textMuted dark:text-gray-400';
}
